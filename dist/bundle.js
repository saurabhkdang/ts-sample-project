...
define("state/project-state", ["require", "exports", "models/project", "models/project"], function (require, exports, project_js_1, project_js_2) {
    ...
    class ProjectState extends State {
        ...
        addProject(title, description, noOfPeople) {
            const newProject = new project_js_1.Project(Math.random().toString(), title, description, noOfPeople, project_js_2.ProjectStatus.Active);
            /* const newProject = {
...
define("components/project-input", ["require", "exports", "components/base-component", "utils/validation", "decorators/autobind", "state/project-state"], function (require, exports, base_component_js_1, validation_js_1, autobind_js_1, project_state_js_1) {
    ...
    // Project Class
    class ProjectInput extends base_component_js_1.BaseClass {
        constructor() {
    ...
    __decorate([
        autobind_js_1.autobind //Decorator
...
define("components/project-item", ["require", "exports", "components/base-component", "decorators/autobind"], function (require, exports, base_component_js_2, autobind_js_2) {
    ...
    class ProjectItem extends base_component_js_2.BaseClass {
        get persons() {
...
define("components/project-list", ["require", "exports", "components/base-component", "decorators/autobind", "state/project-state", "models/project", "components/project-item"], function (require, exports, base_component_js_3, autobind_js_3, project_state_js_2, project_js_3, project_item_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ProjectList = void 0;
    // Project List Class
    class ProjectList extends base_component_js_3.BaseClass {
        constructor(type) {
